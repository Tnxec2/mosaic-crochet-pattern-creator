  ...
  const renderSwitch = (value: ACTION_TYPES) => {
    switch (value) {
      case ACTION_TYPES.NONE:
        return <img src={`./assets/empty.svg`} alt={value} title="Empty"></img>;
      case ACTION_TYPES.COLOR:
        return (
          <img
            ...
            style={{
              backgroundColor:
                patternState.colors[patternState.selectedColorIndex],
            }}
          ></img>
        );
      default:
          ...
          {Object.values(ACTION_TYPES).map((value) => (
            <button
              ...
              className={`btn btn-outline-info btn-sm ms-1 mb-1 ${
                patternState.selectedAction === value ? "selected-action" : ""
              }`}
